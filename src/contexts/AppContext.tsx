...
export type PageType = 'home' | 'student' | 'chat' | 'parent' | 'safety' | 'onboarding' | 'pricing' | 'school' | 'settings' | 'progress' | 'shop' | 'leaderboard' | 'explore' | 'compliance' | 'portfolio' | 'admin' | 'terms' | 'privacy' | 'referral';
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const protectedPages: PageType[] = ['student', 'chat', 'parent', 'school', 'settings', 'progress', 'shop', 'leaderboard', 'compliance', 'portfolio', 'admin', 'referral'];
