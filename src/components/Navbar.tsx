                      ...
                      <div className="py-1">
                        {profile.role === 'parent' && (
                          <>
                            ...
                            <button
                              onClick={() => { setCurrentPage('registration'); setUserMenuOpen(false); window.scrollTo({ top: 0 }); }}
                              className="w-full px-4 py-2.5 text-left text-sm font-body text-charcoal/70 hover:bg-indigo-50 hover:text-indigo-600 transition-all flex items-center gap-3"
                            >
